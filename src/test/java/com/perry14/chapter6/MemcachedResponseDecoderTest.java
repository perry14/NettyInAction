...
import com.perry14.chapter6.MemcachedRequest.Opcode;
import com.perry14.chapter6.MemcachedRequest.Status;
import com.perry14.chapter6.MemcachedResponse;
import com.perry14.chapter6.MemcachedResponseDecoder;
...
public class MemcachedResponseDecoderTest {
	...
	private static void assertResponse(MemcachedResponse response, byte magic, byte opCode, short status, int expires,
